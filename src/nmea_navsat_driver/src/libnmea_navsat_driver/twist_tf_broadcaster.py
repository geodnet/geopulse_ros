...
def generate_launch_description():
    ...
    # TF broadcaster from twist (velocity integration)
    twist_tf_broadcaster = Node(
        package="nmea_navsat_driver", executable="twist_tf_broadcaster", name="twist_tf_broadcaster", output="screen"
    )
